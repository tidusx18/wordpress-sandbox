		...
		<div class="comment-text">
			...
			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>
				<div class="review-box">
					<div itemscope itemtype="http://schema.org/Rating"  title="<?php echo sprintf(__( 'Rated %d out of 5', 'jeg_textdomain' ), $rating) ?>" class="star-rating">
						<span style="width:<?php echo ( intval( get_comment_meta( $GLOBALS['comment']->comment_ID, 'rating', true ) ) / 5 ) * 100; ?>%"></span>												
					</div>
					<div class="reviews_no">
						<?php echo sprintf(__( 'Rated %d out of 5', 'jeg_textdomain' ), $rating); ?>
					</div>
				</div>
			<?php endif; ?>
