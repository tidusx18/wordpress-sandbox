...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row">
		...
		<input type="submit" class="btn" name="login" value="<?php _e( 'Login', 'jeg_textdomain' ); ?>" />
		<input type="hidden" name="redirect" value="<?php echo esc_url( $redirect ) ?>" />
		<a class="lost_password" href="<?php echo esc_url( wp_lostpassword_url( home_url() ) ); ?>"><?php _e( 'Lost Password?', 'jeg_textdomain' ); ?></a>
	</p>
